...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return gRPCgenerisano.F.internal_static_LogEntry_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return gRPCgenerisano.F.internal_static_LogEntry_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            gRPCgenerisano.LogEntry.class, gRPCgenerisano.LogEntry.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof gRPCgenerisano.LogEntry)) {
      return super.equals(obj);
    }
    gRPCgenerisano.LogEntry other = (gRPCgenerisano.LogEntry) obj;
  ...
  public static gRPCgenerisano.LogEntry parseFrom(
  ...
  public static gRPCgenerisano.LogEntry parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static gRPCgenerisano.LogEntry parseFrom(
  ...
  public static gRPCgenerisano.LogEntry parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static gRPCgenerisano.LogEntry parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static gRPCgenerisano.LogEntry parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(gRPCgenerisano.LogEntry prototype) {
  ...
  public static final class Builder extends
      ...
      gRPCgenerisano.LogEntryOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return gRPCgenerisano.F.internal_static_LogEntry_descriptor;
    }
    ...
    // Construct using gRPCgenerisano.LogEntry.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public gRPCgenerisano.LogEntry getDefaultInstanceForType() {
      return gRPCgenerisano.LogEntry.getDefaultInstance();
    }

    @java.lang.Override
    public gRPCgenerisano.LogEntry build() {
      gRPCgenerisano.LogEntry result = buildPartial();
    ...
    @java.lang.Override
    public gRPCgenerisano.LogEntry buildPartial() {
      gRPCgenerisano.LogEntry result = new gRPCgenerisano.LogEntry(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(gRPCgenerisano.LogEntry result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof gRPCgenerisano.LogEntry) {
        return mergeFrom((gRPCgenerisano.LogEntry)other);
      } else {
    ...
    public Builder mergeFrom(gRPCgenerisano.LogEntry other) {
      if (other == gRPCgenerisano.LogEntry.getDefaultInstance()) return this;
  ...
  private static final gRPCgenerisano.LogEntry DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new gRPCgenerisano.LogEntry();
  }

  public static gRPCgenerisano.LogEntry getDefaultInstance() {
